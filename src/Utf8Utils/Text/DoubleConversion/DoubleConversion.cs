namespace Utf8Utils.Text.DoubleConversion
{
    ...
    public static unsafe class DoubleConversion
    {
        ...
        /// <summary>
        /// 浮動小数点数を10進文字列化。
        /// float → <see cref="NumberStringBuffer"/>
        /// </summary>
        public static bool ToString(float v, out NumberStringBuffer buffer)
        {
            ...
            buffer = default(NumberStringBuffer);
            ...
            {
                var result = ToString(v, true, p, out var len, out var exp);
        ...
        /// <summary>
        /// 浮動小数点数を10進文字列化。
        /// double → <see cref="NumberStringBuffer"/>
        /// </summary>
        public static bool ToString(double v, out NumberStringBuffer buffer)
        {
            ...
            fixed (byte* p = buffer.Digits)
            {
                var result = ToString(v, false, p, out var len, out var exp);
                buffer.Length = (byte)len;
                buffer.DecimalExponent = (short)exp;
                return result;
            }
